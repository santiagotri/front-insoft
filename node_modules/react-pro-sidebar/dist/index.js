...
var Overlay = function (_a) {
    ...
    return (React__default["default"].createElement(StyledOverlay, { "data-testid": "overlay-test-id", className: "overlay", onClick: onOverlayClick, onKeyPress: onOverlayClick, role: "button", tabIndex: 0, "aria-label": "overlay", overlayColor: overlayColor }));
};
...
var SidebarFR = function (_a, ref) {
    ...
    return (React__default["default"].createElement(StyledSidebar, __assign({ ref: ref, "data-testid": "sidebar-test-id", collapsed: collapsedContext, broken: brokenContext, toggled: toggledContext, rtl: rtlContext, width: widthContext, collapsedWidth: collapsedWidthContext, transitionDuration: transitionDurationContext !== null && transitionDurationContext !== void 0 ? transitionDurationContext : 300, className: classnames('sidebar', { collapsed: collapsedContext, toggled: toggledContext, broken: brokenContext }, className) }, rest),
        React__default["default"].createElement(StyledInnerSidebar, { "data-testid": "inner-sidebar-test-id", className: "sidebar-inner", backgroundColor: backgroundColor }, children),
        image && (React__default["default"].createElement(StyledSidebarImage, { "data-testid": "sidebar-img-test-id", src: image, alt: "sidebar background", className: "sidebar-bg" })),
        brokenContext && toggledContext && (React__default["default"].createElement(Overlay, { onOverlayClick: handleOverlayClick, overlayColor: overlayColor }))));
};
...
var MenuFR = function (_a, ref) {
    ...
    var _c = React__default["default"].useState(), menuState = _c[0], setMenuState = _c[1];
    var updateMenuState = React__default["default"].useCallback(function (values) {
        setMenuState(function (prevState) { return (__assign(__assign({}, prevState), values)); });
    }, []);
    var providerValue = React__default["default"].useMemo(function () { return (__assign(__assign({}, menuState), { updateMenuState: updateMenuState })); }, [menuState, updateMenuState]);
    React__default["default"].useEffect(function () {
    ...
    return (React__default["default"].createElement(MenuContext.Provider, { value: providerValue },
        React__default["default"].createElement("nav", __assign({ ref: ref, className: classnames('menu', className) }, rest),
...
var SubMenuContentFR = function (_a, ref) {
    ...
    return (React__default["default"].createElement(StyledSubMenuContent, __assign({ ref: ref, firstLevel: firstLevel, collapsed: collapsed, className: "sub-menu-content", open: open, openWhenCollapsed: openWhenCollapsed }, rest),
        React__default["default"].createElement(StyledUl, null, children)));
};
...
var SubMenuFR = function (_a, ref) {
    ...
    var _h = React__default["default"].useState(!!defaultOpen), openDefault = _h[0], setOpenDefault = _h[1];
    var _j = React__default["default"].useState(false), openWhenCollapsed = _j[0], setOpenWhenCollapsed = _j[1];
    var _k = React__default["default"].useState(), popperInstance = _k[0], setPopperInstance = _k[1];
    ...
    var SubMenuContentRef = React__default["default"].useRef(null);
    ...
    return (React__default["default"].createElement(StyledSubMenu, { ref: ref, className: classnames('sub-menu', 'menu-item', { active: active }, { disabled: disabled }, { open: openSubmenu !== null && openSubmenu !== void 0 ? openSubmenu : open }, className), menuItemStyles: renderMenuItemStyles === null || renderMenuItemStyles === void 0 ? void 0 : renderMenuItemStyles({ level: level, collapsed: !!collapsed, disabled: disabled, active: active }) },
        React__default["default"].createElement(StyledMenuItemAnchor, __assign({ ref: anchorRef, rtl: rtl, title: title, level: level, collapsed: collapsed, className: "menu-anchor", onClick: handleSlideToggle, disabled: disabled, active: active }, rest),
            icon && (React__default["default"].createElement(StyledMenuIcon, { rtl: rtl, className: "menu-icon" }, icon)),
            prefix && (React__default["default"].createElement(StyledMenuPrefix, { collapsed: collapsed, transitionDuration: transitionDuration, firstLevel: level === 0, className: "menu-prefix", rtl: rtl }, prefix)),
            React__default["default"].createElement(StyledMenuLabel, { className: "menu-label" }, label),
            suffix && (React__default["default"].createElement(StyledMenuSuffix, { collapsed: collapsed, transitionDuration: transitionDuration, firstLevel: level === 0, className: "menu-suffix" }, suffix)),
            React__default["default"].createElement(StyledExpandIconWrapper, { rtl: rtl, className: "expand-icon", collapsed: collapsed, level: level }, renderExpandIcon ? (renderExpandIcon({
                collapsed: !!collapsed,
                level: level,
        ...
        React__default["default"].createElement(SubMenuContent, { ref: SubMenuContentRef, openWhenCollapsed: openWhenCollapsed, open: openSubmenu !== null && openSubmenu !== void 0 ? openSubmenu : open, firstLevel: level === 0, collapsed: collapsed, defaultOpen: openDefault }, childNodes.map(function (node) {
...
var MenuItemFR = function (_a, ref) {
    ...
    return (React__default["default"].createElement(StyledMenuItem, { ref: ref, className: classnames('menu-item', { active: active }, { disabled: disabled }, className), menuItemStyles: renderMenuItemStyles === null || renderMenuItemStyles === void 0 ? void 0 : renderMenuItemStyles({ level: level, collapsed: !!collapsed, disabled: disabled, active: active }) },
        React__default["default"].createElement(StyledMenuItemAnchor, __assign({ className: "menu-anchor", level: level, collapsed: collapsed, rtl: rtl, disabled: disabled, active: active }, rest),
            icon && (React__default["default"].createElement(StyledMenuIcon, { rtl: rtl, className: "menu-icon" }, icon)),
            prefix && (React__default["default"].createElement(StyledMenuPrefix, { collapsed: collapsed, transitionDuration: transitionDuration, firstLevel: level === 0, className: "menu-prefix", rtl: rtl }, prefix)),
            React__default["default"].createElement(StyledMenuLabel, { className: "menu-label" }, children),
            suffix && (React__default["default"].createElement(StyledMenuSuffix, { collapsed: collapsed, transitionDuration: transitionDuration, firstLevel: level === 0, className: "menu-suffix" }, suffix)))));
};
...
var ProSidebarProvider = function (_a) {
    var children = _a.children;
    return (React__default["default"].createElement(SidebarProvider, null,
